...
function HeroSection({ theme }) {
  ...
  return (
    ...
    >
      <SectionBackdrop variant="hero" theme={theme} />
      ...
      <div className="relative mx-auto max-w-6xl text-center">
        <p
          className={`animate-fade-up text-base uppercase tracking-[0.2em] sm:text-lg ${isDark ? "text-zinc-400" : "text-zinc-700"}`}
          style={{ "--delay": "80ms" }}
        >
          A clean editorial landing page
        </p>
        <h1
          className={`animate-fade-up mt-6 text-[clamp(3.4rem,6.5vw,7.2rem)] leading-[0.88] tracking-[-0.09em] ${isDark ? "text-zinc-50" : "text-zinc-900"}`}
          style={{ "--delay": "180ms" }}
        >
        ...
        <p
          className={`animate-fade-up mx-auto mt-5 max-w-3xl text-xl leading-10 sm:text-2xl ${isDark ? "text-zinc-300" : "text-zinc-700"}`}
          style={{ "--delay": "280ms" }}
        >
