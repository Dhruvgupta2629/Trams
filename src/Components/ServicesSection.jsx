  ...
  return (
    ...
    >
      ...
      <div className="order-1 max-w-md lg:order-2 lg:ml-auto">
        <h2
          className="animate-fade-up text-[clamp(2.5rem,4vw,4.8rem)] leading-[0.98] tracking-[-0.08em] text-zinc-900"
          style={{ "--delay": "80ms" }}
        >
          See how we can help you <Highlight tone="yellow">progress</Highlight>
        </h2>
        <p
          className="animate-fade-up mt-4 text-xl leading-10 text-zinc-700 sm:text-2xl"
          style={{ "--delay": "160ms" }}
        >
